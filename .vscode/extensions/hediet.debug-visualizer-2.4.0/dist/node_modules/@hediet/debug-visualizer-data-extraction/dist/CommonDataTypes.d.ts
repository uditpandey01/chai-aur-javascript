export declare type KnownVisualizationData = TreeVisualizationData | AstTreeVisualizationData | GraphvizDotVisualizationData | GraphVisualizationData | GraphVisualizationData | GridVisualizationData | ImageVisualizationData | MonacoTextVisualizationData | MonacoTextDiffVisualizationData | TableVisualizationData | PlotlyVisualizationData | SimpleTextVisualizationData | SvgVisualizationData;
...
export declare type LineColumnRange = {
    /**
     * The start position
     */
...
export declare type LineColumnPosition = {
    /**
...
export declare type MonacoTextDiffVisualizationData = {
    kind: {
        text: true;
    };
    /**
